...
export default function TableOfContents({ headings }: TOCProps) {
  ...
  return (
    <aside className="sticky top-24 max-h-[80vh] overflow-y-auto px-4 py-2 text-base text-zinc-700 dark:text-zinc-300">
      <h3 className="mb-3 text-xl font-bold uppercase tracking-wide text-zinc-500">
        On this page
      </h3>
